...
os_main.o: ./src/os/os_main.c ./src/os/os_main.h
	gcc -c ./src/os/os_main.c -I./src/general -I./src/os -I./src/hal -o ./obj/os_main.o

tasks.o: ./src/os/tasks.c
	gcc -c ./src/os/tasks.c -I./src/general -I./src/os -o ./obj/tasks.o

timer.o: ./src/hal/timer.c
	gcc -c ./src/hal/timer.c -I./src/general -I./src/hal -o ./obj/timer.o
